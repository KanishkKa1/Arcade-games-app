...
class Game:
    def __init__(self):
        ...
        self.birdX = 100
        self.birdY = 100
        self.pipesX = [width, width+200, width+400,
                       width+600, width+800, width+1000, width+1200]
    ...
    def randomPipe(self):
        return random.randrange(int(heigth/2)+50, heigth-150)

    def randomRotatedPipe(self):
        return random.randrange(-int(heigth/2)+100, -120)
    ...
    def gameOver(self):
        if(self.isCollide()):
            ...
            self.screenText("Game Over!", (255, 255, 255), 450,
                            300, 84, "Fixedsys", bold=True)
            self.screenText("Press Enter To Play Again",
                            (255, 255, 255), 400, 600, 48, "Fixedsys", bold=True)
            self.pipeVel = 0
            self.flap = 0
            self.rotateAngle = -90
            if(self.playSound):
